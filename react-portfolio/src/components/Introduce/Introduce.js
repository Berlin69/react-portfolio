...
import { introduceImages } from '../__data/introduce-data';
            ...
            <div className="container">
                <div className="introduce__inner">
                    ...
                    <div className="introduce__greetings-wrapper">
                        <h4 className={`introduce__greetings-text ${isDayTheme ? 'light' : ''}`}>
                    ...
                    <div className="introduce__numbers-wrapper">
                        <div className="introduce__numbers-item">
                            ...
                            <p className={`introduce__number-text ${isDayTheme ? 'light' : ''}`}>
                                {experienceText}
                            </p>
                        </div>
                        <div className="introduce__numbers-item">
